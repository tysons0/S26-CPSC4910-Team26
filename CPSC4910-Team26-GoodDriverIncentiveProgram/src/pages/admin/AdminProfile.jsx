      ...
      <div className="profile-card" style={{ marginTop: "2rem" }}>
        ...
        <div className="profile-item">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "0.75rem", marginTop: "0.5rem" }}>
            <label style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", cursor: "pointer", gap: "0.35rem", padding: "0.85rem 1rem", borderRadius: "12px", border: emailNotifs ? "1px solid var(--border)" : "2px solid #667eea", backgroundColor: emailNotifs ? "var(--surface)" : "rgba(102, 126, 234, 0.12)" }}>
              <input
                type="radio"
            ...
            <label style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", cursor: "pointer", gap: "0.35rem", padding: "0.85rem 1rem", borderRadius: "12px", border: emailNotifs ? "2px solid #667eea" : "1px solid var(--border)", backgroundColor: emailNotifs ? "rgba(102, 126, 234, 0.12)" : "var(--surface)" }}>
              <input
                type="radio"
                name="email-notifications"
                checked={emailNotifs}
